...
- Create Angular project with ng: `ng new parkingmanagements.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`parkingmanagements.client.esproj`).
